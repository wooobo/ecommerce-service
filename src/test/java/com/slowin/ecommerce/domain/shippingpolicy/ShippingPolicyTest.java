...
class ShippingPolicyTest {
    ...
    void create() {
        ...
        DeliveryFee deliveryFee = new DeliveryFee(DeliveryFeeType.NOT_FREE, 2500L, 2500L, 5000L, 0L,
            1000L, 1000L);

        // when
        ShippingPolicy shippingPolicy = new ShippingPolicy(policyName, usable, deliveryFee, 1L, 2L);
